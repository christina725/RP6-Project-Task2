 ...
 * ****************************************************************************
 * Changelog:
 * - v. 1.8 2012  by Dominik S. Herwald
 *      - FIX for Version 1.7: Default direction change set to medium
 *      - FIX: Version number set to 1.8 for RP6Lib
 * - v. 1.6 2012  by Dominik S. Herwald
 *      - FIX: Stopwatch 1ms timer was slightly off, changed >= 10 to >= 9
 *      - NEW: CHANGE_DIRECTION_FAST, MEDIUM and SLOW options
 *            are now available to make direction changes faster
